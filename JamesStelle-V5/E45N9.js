module.exports = {
    run: function() {
        ...
        // Log current creep counts (for E45N9)
        ...
        switch (true) {
            case creepCount.harvester < minCreeps.harvester:
                ...
                creepBody = [WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE];
                //100*5+50*6=800
                break;
